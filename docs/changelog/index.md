...
- Upgrading to v6 (the generated JSON follows the BPMN standard; job types, messages, signals, errors and escalations moved into shared files)? See the [v6 Migration Guide](./v6).
- Upgrading to v5 (deprecated `BpmnValidationRule` / `ValidationContext` aliases removed)? See the [v5 Migration Guide](./v5).
