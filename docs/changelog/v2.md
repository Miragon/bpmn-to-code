...
**Migration**: search your BPMN files for `name="additionalVariables"` and split each into the two directional variants. BPMN files cannot be rewritten automatically, and `Variables.<Element>.X` source references need manual review.
...
Apply the following steps to move from v1.1.0 to v2.0.0.
