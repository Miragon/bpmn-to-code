...
class Camunda7ModelExtractor : EngineSpecificExtractor {
    ...
    /**
     * Maps a camunda:inputParameter / camunda:outputParameter element to a variable mapping.
    ...
    private fun extractMultiInstanceVariables(
        ...
        val collectionVariables = loops.mapNotNull { it.camundaCollection }.map { Triple(it, VariableDirection.INPUT, it) }
