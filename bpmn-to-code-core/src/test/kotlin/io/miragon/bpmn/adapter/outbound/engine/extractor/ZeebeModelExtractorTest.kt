            ...
            testSubscribeNewsletterBpmnModel(
                ...
                flowNodes = listOf(
                    ...
                    FlowNodeDefinition("Activity_SendConfirmationMail", BpmnNodeType.Activity.Task(TaskKind.SERVICE),
                        ...
                        variables = listOf(VariableDefinition("testVariable", VariableDirection.INPUT, "=\"123\""), VariableDefinition("subscriptionId", VariableDirection.INPUT, "=subscriptionId")),
                        parentId = "SubProcess_Confirmation",
                    ...
                    FlowNodeDefinition("Activity_NotifyCommunity", BpmnNodeType.Activity.Task(TaskKind.SERVICE),
                        ...
                        properties = FlowNodeProperties.ServiceTask(ServiceTaskDefinition("Activity_NotifyCommunity", engineSpecificProperties = mapOf(IMPL_VALUE_KEY to "newsletter.notifyCommunity", IMPL_KIND_KEY to "JOB_WORKER"))),
                        previousElements = listOf("Gateway_SplitNotifications"),
                        followingElements = listOf("Gateway_JoinNotifications")),
