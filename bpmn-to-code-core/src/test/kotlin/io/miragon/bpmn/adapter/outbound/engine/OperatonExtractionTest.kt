...
class OperatonExtractionTest {
    ...
    fun `extract returns valid ProcessModel with operaton namespace`() {
        ...
        assertThat(implementations["Activity_SendWelcomeMail"]).isEqualTo(TaskImplementation.DelegateExpression("newsletter.sendWelcomeMail"))
        assertThat(implementations["Activity_SendConfirmationMail"]).isEqualTo(TaskImplementation.ExternalTask("newsletter.sendConfirmationMail"))
        ...
        assertThat(implementations["Activity_NotifyCommunity"]).isEqualTo(TaskImplementation.DelegateExpression("newsletter.notifyCommunity"))
