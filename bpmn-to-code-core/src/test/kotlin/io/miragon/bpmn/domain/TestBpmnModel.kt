...
fun testSubscribeNewsletterBpmnModel(
    ...
    flowNodes: List<FlowNodeDefinition> = listOf(
        ...
        FlowNodeDefinition("CompensationEndEvent_RegistrationAborted", BpmnNodeType.Event(EventShape.END_EVENT),
            displayName = "Registration aborted",
            previousElements = listOf("CallActivity_AbortRegistration")),
        FlowNodeDefinition("CompensationEvent_OnSubscriptionCounter", BpmnNodeType.Event(EventShape.BOUNDARY_EVENT),
            displayName = "Registration aborted",
        ...
        FlowNodeDefinition("EndEvent_RegistrationNotPossible", BpmnNodeType.Event(EventShape.END_EVENT),
        ...
        FlowNodeDefinition("ErrorEvent_InvalidMail", BpmnNodeType.Event(EventShape.BOUNDARY_EVENT),
        ...
        FlowNodeDefinition("StartEvent_SubmitRegistrationForm", BpmnNodeType.Event(EventShape.START_EVENT),
        ...
        FlowNodeDefinition("Timer_After3Days", BpmnNodeType.Event(EventShape.BOUNDARY_EVENT),
        ...
        FlowNodeDefinition("Timer_EveryDay", BpmnNodeType.Event(EventShape.BOUNDARY_EVENT),
...
fun testSendNewsletterBpmnModel(
    ...
    flowNodes: List<FlowNodeDefinition> = listOf(
        ...
        FlowNodeDefinition("event_mailRejected", BpmnNodeType.Event(EventShape.START_EVENT),
        ...
        FlowNodeDefinition("timer_noRejectionForOneDay", BpmnNodeType.Event(EventShape.INTERMEDIATE_CATCH_EVENT),
        ...
        FlowNodeDefinition("escalationEndEvent_nofitySupport", BpmnNodeType.Event(EventShape.END_EVENT),
            parentId = "eventSubProcess_errorHandling",
            previousElements = listOf("gateway_canSendAgain")),
        FlowNodeDefinition("event_mailRejectedAgain", BpmnNodeType.Event(EventShape.INTERMEDIATE_CATCH_EVENT),
            parentId = "eventSubProcess_errorHandling",
