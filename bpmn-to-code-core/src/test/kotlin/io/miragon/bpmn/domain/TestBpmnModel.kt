...
fun testSubscribeNewsletterBpmnModel(
    ...
    flowNodes: List<FlowNodeDefinition> = listOf(
        ...
        FlowNodeDefinition("Activity_SendWelcomeMail", BpmnNodeType.Activity.Task(TaskKind.SERVICE),
            ...
            variables = listOf(VariableDefinition("subscriptionId", VariableDirection.INPUT)),
            previousElements = listOf("Gateway_SplitNotifications"), followingElements = listOf("Gateway_JoinNotifications"),
        ...
        FlowNodeDefinition("Activity_NotifyCommunity", BpmnNodeType.Activity.Task(TaskKind.SERVICE),
            ...
            properties = FlowNodeProperties.ServiceTask(ServiceTaskDefinition("Activity_NotifyCommunity", engineSpecificProperties = mapOf(IMPL_VALUE_KEY to "newsletter.notifyCommunity"))),
            previousElements = listOf("Gateway_SplitNotifications"), followingElements = listOf("Gateway_JoinNotifications"),
            engineSpecificProperties = mapOf(ASYNC_BEFORE_KEY to true, ASYNC_AFTER_KEY to true, EXCLUSIVE_KEY to false)),
        FlowNodeDefinition("Gateway_SplitNotifications", BpmnNodeType.Gateway(GatewayKind.PARALLEL),
            previousElements = listOf("SubProcess_Confirmation"), followingElements = listOf("Activity_SendWelcomeMail", "Activity_NotifyCommunity")),
        FlowNodeDefinition("Gateway_JoinNotifications", BpmnNodeType.Gateway(GatewayKind.PARALLEL),
            previousElements = listOf("Activity_SendWelcomeMail", "Activity_NotifyCommunity"), followingElements = listOf("EndEvent_RegistrationCompleted")),
        ...
        FlowNodeDefinition("CompensationTask_DecrementSubscriptionCounter", BpmnNodeType.Activity.Task(TaskKind.SERVICE),
            ...
            properties = FlowNodeProperties.ServiceTask(ServiceTaskDefinition("CompensationTask_DecrementSubscriptionCounter", engineSpecificProperties = mapOf(IMPL_VALUE_KEY to "counterClass")))),
        ...
        FlowNodeDefinition("SubProcess_Confirmation", BpmnNodeType.Activity.SubProcess(SubProcessKind.PLAIN),
            ...
            previousElements = listOf("serviceTask_incrementSubscriptionCounter"), followingElements = listOf("Gateway_SplitNotifications")),
...
fun testSendNewsletterBpmnModel(
    ...
    flowNodes: List<FlowNodeDefinition> = listOf(
        ...
        FlowNodeDefinition("event_mailRejected", BpmnNodeType.Event(EventShape.START_EVENT, EventDefinitionType.MESSAGE),
            ...
            parentId = "eventSubProcess_errorHandling", interrupting = true,
